...
FMorseConverter::~FMorseConverter()
{
	if (MorseCodeBook != nullptr)
	{
		delete MorseCodeBook;
	}
}
...
wstring FMorseConverter::decode_Inner(wstring InCode, FCodeBook* InCodeBook)
{
	wstring GivenCode = InCode;
...
wstring FMorseConverter::encode_Inner(wstring InString, FCodeBook* InCodeBook)
{
